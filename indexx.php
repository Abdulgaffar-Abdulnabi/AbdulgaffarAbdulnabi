...
<body>
        ...
        if (empty($username) || empty($password)) {
            ...
            if (!filter_var($username, FILTER_VALIDATE_EMAIL)) {
                ...
                if ($password !== $student_number) {
                    ...
                    // Login işlemi başarılı, kullanıcıyı başka bir sayfaya yönlendir
                    header("Location: welcome.php?user=$student_number");
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        <label for="username">Kullanıcı Adı (Öğrenci Mailiniz):</label><br>
